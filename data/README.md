...
| technical_highest         | double    | best technical rank earned by a given baker across all episodes appeared (lower is better)                                                                |
| technical_lowest          | double    | worst technical rank earned by a given baker across all episodes appeared (lower is better)                                                               |
| technical_median          | double    | median technical rank earned by a given baker across all episodes appeared (lower is better)                                                              |
