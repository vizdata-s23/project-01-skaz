...
format <- tribble(
  ...
  0,        4.4,        "#88B7D1",   "BBC Two",
  4.4,        7.4,      "#EE8B8B",   "BBC One",
  7.4,        11,       "#A2A6AC",   "Channel 4"
  )



#bbc_two <- readPNG(here("project-01-skaz","data","BBC_Two_logo.png"))
#bbc_one <- readPNG(here("project-01-skaz", "data","BBC_One_logo.png"))
#channel4 <- readPNG(here("project-01-skaz","data","Channel_4_logo.png"))
...
ggplot(ratings_ppl, aes(x = series, y = viewers_7day_mean))+
  ...
  geom_point(data = ratings_ppl, aes(x = factor(series), y = viewers_7day_mean, color = presenters), size = 14)+
...
ggplot(new) +
  ...
  labs(x= "Viewers (in Millions)",
       ...
       caption= "The gray lines represent the median viewership over all episodes")+
  theme_minimal()
