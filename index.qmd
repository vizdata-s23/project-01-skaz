...
format <- tribble(
  ~box_min, ~box_max, ~color_f,      ~channel_f,
  0,        4.4,        "darkgreen",   "BBC Two",
  4.4,        7.4,        "darkblue",   "BBC One",
  7.4,        11,       "darkred",   "Channel 4"
  )


library("png")
library("grid")
bbc_two <- readPNG("~/project-01-skaz/data/BBC_Two_logo.png")
bbc_one <- readPNG("~/project-01-skaz/data/BBC_One_logo.png")
channel4 <- readPNG("~/project-01-skaz/data/Channel_4_logo.png")
...
ggplot(ratings_ppl, aes(x = series, y = viewers_7day_mean))+
  ...
  annotation_custom(two, xmin=0, xmax=4, ymin=ymin, ymax=ymax) +
  annotation_custom(one, xmin=4.1, xmax=7, ymin=ymin, ymax=ymax) +
  annotation_custom(four, xmin=7.1, xmax=10, ymin=ymin, ymax=ymax) +
  theme_minimal()+
  #scale_color_bakeoff(palette = "showstopper") +
  labs(
    title = "Number of Viewers across Series",
