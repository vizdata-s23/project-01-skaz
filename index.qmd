...
plot1 <- ggplot(bakers, aes(x = technical_bottom, 
  ...
  labs(
    ...
    vs. Technical Challenge Top/Bottom 3 Performance",
...
plot2 <- ggplot(bakers, aes(x = technical_lowest, 
                            y = percent_episodes_appeared)) +
  geom_point(shape = 1, color = "#3F195E", aes(text = baker_stats)) +
  geom_smooth(aes(x = technical_lowest, color = "# of Last Places"),
              se = FALSE, method = "lm") +
  geom_point(aes(x = technical_winner, text = baker_stats), shape = 16, 
             color = "#51A186") +
  geom_smooth(aes(x = technical_winner, color = "# of First Places"), 
              se = FALSE, method = "lm") +
